"""
Django settings for saas_notes project.
...
SECRET_KEY = "django-insecure-1kcjuv-x&pymi_s^har6s8__iv4h-zoasi8=q*+l-+qgy0g9(7"
...
WSGI_APPLICATION = "saas_notes.wsgi.application"
